...
$coupon = CouponData::getById($_SESSION["coupon"]);
	...
	<?php else:?>
		...
		<?php 
			if ($pm->name == 'Deposito Bancario'){  ?>
		<tr>
			<td>Pago electrónico: </td><td> <div id="paypal-button-container"></div> </td>
		</tr>
		<?php
			}
		?>
...
<script src="https://www.paypalobjects.com/api/checkout.js"> </script>
  <script>
    paypal.Button.render({
        ...
        client: {
            sandbox:    '<?php echo 'ASOEtcVamdxq-btySDG0jSieTguFzysI8W_4DFJAe9cKyCtHbqbllD5_JSkTFGMIVoeqiWjIBJ1U_RoY'; ?>',
            production: '<?php echo 'ASOEtcVamdxq-btySDG0jSieTguFzysI8W_4DFJAe9cKyCtHbqbllD5_JSkTFGMIVoeqiWjIBJ1U_RoY'; ?>'
        },
        ...
        onAuthorize: function(data, actions) {
            ...
            return actions.payment.execute().then(function() {
                ...
                window.location = '<?php echo 'http://localhost/katana-master/index.php?action=buy' ?>';
